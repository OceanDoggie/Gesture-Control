...
class GestureAPI {
    ...
    getGestureInstructions(req, res) {
        ...
        const instruction = instructions[gesture];
        if (instruction) {
            res.json({
                success: true,
                data: instruction
...
// 导出API方法
export const processGesture = (req, res) => gestureAPI.processGesture(req, res);
